...
class Calculadora(tk.Tk):
    ...
    def _creacion_componentes(self):
        ...
        entrada = tk.Entry(entrada_frame, font=('arial', 18, 'bold'),
                            textvariable=self.entrada_texto, width=31, justify=tk.RIGHT)
        ...
        # nota: bd -> border
        # Botón limpiar
        boton_limpiar = tk.Button(botones_frame, text='C', width='34', height=3,
        ...
        # Segunda fila
        boton_siete = tk.Button(botones_frame, text='7', width=9, height=3,
                                bd=0, bg='#fff', cursor='hand2', command=lambda: self._evento_click('7'))
        boton_siete.grid(row=1, column=0, padx=1, pady=1)
        boton_ocho = tk.Button(botones_frame, text='8', width=9, height=3,
                                bd=0, bg='#fff', cursor='hand2', command=lambda: self._evento_click('8'))
        boton_ocho.grid(row=1, column=1, pady=1)
        boton_nueve = tk.Button(botones_frame, text='9', width=9, height=3,
        ...
        # Tercera fila
        boton_cuatro = tk.Button(botones_frame, text='4', width=9, height=3,
                                bd=0, bg='#fff', cursor='hand2', command=lambda: self._evento_click('4'))
        boton_cuatro.grid(row=2, column=0, padx=1, pady=1)
        boton_cinco = tk.Button(botones_frame, text='5', width=9, height=3,
                               bd=0, bg='#fff', cursor='hand2', command=lambda: self._evento_click('5'))
        boton_cinco.grid(row=2, column=1, pady=1)
        boton_seis = tk.Button(botones_frame, text='6', width=9, height=3,
        ...
        # Cuarta fila
        boton_uno = tk.Button(botones_frame, text='1', width=9, height=3,
                                 bd=0, bg='#fff', cursor='hand2', command=lambda: self._evento_click('1'))
        boton_uno.grid(row=3, column=0, padx=1, pady=1)
        boton_dos = tk.Button(botones_frame, text='2', width=9, height=3,
                                bd=0, bg='#fff', cursor='hand2', command=lambda: self._evento_click('2'))
        boton_dos.grid(row=3, column=1, pady=1)
        boton_tres = tk.Button(botones_frame, text='3', width=9, height=3,
        ...
        # Quinta fila
        boton_cero = tk.Button(botones_frame, text='0', width=22, height=3, bd=0, bg='#fff',
                               cursor='hand2', command=lambda : self._evento_click(0))
        boton_cero.grid(row=4, column=0, columnspan=2, padx=1, pady=1)

        boton_punto = tk.Button(botones_frame, text='.', width=9, height=3, bd=0,
    ...
    def _evento_evaluar(self):
        # eval - evalua la expresion de tipo str como una expresión aritmética
        try:
            if self.expresion:
